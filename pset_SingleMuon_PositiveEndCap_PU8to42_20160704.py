...
# with command line options: L1TMuonSimulations/Configuration/python/SingleMuonFlatOneOverPt2To7000_PositiveEndCap_cfi.py --step GEN,SIM,DIGI:pdigi_valid,L1,DIGI2RAW,HLT:GRun,RAW2DIGI,L1Reco,RECO --mc --eventcontent RAWSIM --datatier GEN-SIM-RAW --processName RAWSIM --era Run2_2016 --conditions 80X_mcRun2_asymptotic_v14 --customise L1TMuonSimulations/Configuration/customise.cust_pileup --customise_commands process.mix.input.nbPileupEvents.probValue = cms.vdouble(0,0,0,0,0,0,0,0,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0.02857143,0,0,0,0,0,0,0) --beamspot Realistic50ns13TeVCollision --magField 38T_PostLS1 --python_filename pset_SingleMuon_PositiveEndCap_PU8to42.py --fileout file:SingleMuon_PositiveEndCap_PU8to42.root --no_exec -n 10
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SingleMuon_PositiveEndCap_PU8to42.root'),
