...
if True:
  ...
  txt = 'L1TMuonSimulations/Configuration/data/input_SingleMuon_PositiveEndCap_PU200.txt'
  ...
  process.ntupler.outFileName = 'ntuple_SingleMuon_PositiveEndCap_PU200.root'
  process.ntupler.docString = 'SingleMuon_PositiveEndCap_PU200'
