...
config.General.requestName = 'ntuple_SingleMuon_Overlap_3GeV'
...
config.JobType.psetName = 'ntuple_SingleMuon_Overlap_3GeV_20190305.py'
...
#config.Data.outLFNDirBase = '/store/user/jiafulow/L1MuonTrigger/P2_10_4_0/ntuple_SingleMuon_Overlap_3GeV/'
config.Data.outLFNDirBase = '/store/group/l1upgrades/L1MuonTrigger/P2_10_4_0/ntuple_SingleMuon_Overlap_3GeV/'
...
config.Data.splitting = 'FileBased'
config.Data.unitsPerJob = 20  # for ParticleGuns
