...
config.General.requestName = 'ntuple_SingleMuon_Endcap_2GeV'
...
config.JobType.psetName = 'ntuple_SingleMuon_Endcap_2GeV_20190305.py'
...
#config.Data.outLFNDirBase = '/store/user/jiafulow/L1MuonTrigger/P2_10_4_0/ntuple_SingleMuon_Endcap_2GeV/'
config.Data.outLFNDirBase = '/store/group/l1upgrades/L1MuonTrigger/P2_10_4_0/ntuple_SingleMuon_Endcap_2GeV/'
