...
if True:
  txt = 'L1TMuonSimulations/Configuration/data/input_SingleMuon_PositiveEndCap_PU140.txt'
  txt = os.path.join(os.environ['CMSSW_BASE'], 'src', txt)
  fileNames_txt = loadFromFile(txt, fmt='root://cmsxrootd.fnal.gov/%s')
  process.source.fileNames = fileNames_txt
  #
  process.load('L1TMuonSimulations.Analyzers.rpcintegration_cfi')
  process.ntupler.outFileName = 'ntuple_SingleMuon_PositiveEndCap_PU140.root'
  process.ntupler.docString = 'SingleMuon_PositiveEndCap_PU140'
