...
# with command line options: SLHCL1TrackTriggerSimulations/Configuration/python/tower/SingleMuonFlatOneOverPt0p0005To0p5_oc_tt25_cfi.py --conditions auto:upgradePLS3 --eventcontent RAWSIM -s GEN,SIM,DIGI:pdigi_valid,L1TrackTrigger --datatier GEN-SIM-DIGI-RAW --beamspot HLLHC --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2023TTI,SLHCL1TrackTriggerSimulations/Configuration/customise_pgun.cust_useTrackerOnly --customise_commands process.VtxSmeared.ZsizeInm = cms.double(0.075 * 1e-6) --geometry Extended2023TTI --magField 38T_PostLS1 --mc --no_exec --processName RAWSIM -n 1000 --python_filename pset_SingleMuon_oc_tt25.py --fileout SingleMuon_oc_tt25.root
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('SLHCL1TrackTriggerSimulations/Configuration/python/tower/SingleMuonFlatOneOverPt0p0005To0p5_oc_tt25_cfi.py nevts:1000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('SingleMuon_oc_tt25.root'),
...
process.generator = cms.EDProducer("FlatRandomOneOverPtGunProducer2",
    ...
    psethack = cms.string('single muon+/- 1/pt 0.0005 to 0.5 tower 33'),
...
process.VtxSmeared.ZsizeInm = cms.double(0.075 * 1e-6)
