...
if True:
  ...
  txt = 'L1TMuonSimulations/Configuration/data/input_Mu_FlatPt2to100-pythia8-gun_PhaseIITDRSpring19_PU300.txt'
...
if True:
    ...
    process.ntupler.outFileName = 'ntuple_MuMu_FlatPt_PU300.root'
