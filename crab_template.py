...
#config.Data.outLFNDirBase = '/store/user/jiafulow/L1MuonTrigger/9_3_13/XX-LABEL-XX/'
config.Data.outLFNDirBase = '/store/group/l1upgrades/L1MuonTrigger/9_3_13/XX-LABEL-XX/'
...
if test_run:
    ...
    config.Data.totalUnits = config.Data.unitsPerJob * 2
