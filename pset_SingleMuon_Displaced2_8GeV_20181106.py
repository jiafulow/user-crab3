...
process.generator = cms.EDProducer("FlatRandomPtGunProducer2",
    ...
    psethack = cms.string('single muon+/- pt 8 to 7000 flat in 1/pt negative endcap')
)
...
process.VtxSmeared.MaxZ = cms.double(300)            # was 5.3
process.VtxSmeared.MaxT = cms.double(300/29.9792458) # was 0.176789
...
if True:
    ...
    process.ntupler.outFileName = 'ntuple_SingleMuon_Displaced2.root'
