...
if True:
  ...
  txt = 'L1TMuonSimulations/Configuration/data/input_Nu_E10-pythia8-gun_PhaseIITDRSpring19_PU250.txt'
...
if True:
    ...
    #process.ntupler.outFileName = 'ntuple_SingleNeutrino_PU250.root'
