...
if True:
  ...
  txt = 'L1TMuonSimulations/Configuration/data/input_SingleElectron_PhaseIIFall17D-L1TPU140.txt'
...
if True:
    ...
    process.ntupler.outFileName = 'ntuple_SingleElectron_PU140.root'
