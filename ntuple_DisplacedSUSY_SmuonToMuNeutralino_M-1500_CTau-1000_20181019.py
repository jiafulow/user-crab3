...
if True:
  ...
  txt = 'L1TMuonSimulations/Configuration/data/DisplacedSUSY/input_DisplacedSUSY_SmuonToMuNeutralino_M-1500_CTau-1000.txt'
...
if True:
    ...
    process.ntupler.outFileName = 'ntuple_DisplacedSUSY.root'
