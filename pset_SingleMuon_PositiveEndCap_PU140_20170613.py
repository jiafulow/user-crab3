...
# with command line options: L1TMuonSimulations/Configuration/python/SingleMuonFlatOneOverPt2To7000_PositiveEndCap_cfi.py --step GEN,SIM,DIGI:pdigi_valid,L1,L1TrackTrigger,DIGI2RAW,RAW2DIGI --mc --eventcontent RAWSIM --datatier GEN-SIM-DIGI-RAW --processName RAWSIM --conditions auto:phase2_realistic --beamspot HLLHC14TeV --geometry Extended2023D17 --era Phase2C2_timing --pileup AVE_140_BX_25ns --pileup_input dummy.root --python_filename pset_SingleMuon_PositiveEndCap_PU140.py --fileout file:SingleMuon_PositiveEndCap_PU140.root --no_exec --nThreads 4 -n 100
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SingleMuon_PositiveEndCap_PU140.root'),
